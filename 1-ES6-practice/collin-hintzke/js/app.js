...
function displayPics(){
  ...
  // When we switch the declaration of the variable "rando" from var to let, it throws an error because rando is being called in a console log outside of its scope. let only defines variables inside its scope and deeper
  console.log(viewed);
